 ...
 * --------------------------------
 * Cria a credencial do Gerente Administrador (Cristovão) e os dois Postos de Venda.
 * Pronto para uso em produção com PostgreSQL / Supabase.
 */
...
async function main() {
  ...
  // 2. Criar a credencial do Gerente (Cristovão)
  ...
  console.log('');
  console.log('========================================');
  console.log('  CREDENCIAL DO SISTEMA (PRODUÇÃO)');
  console.log('========================================');
